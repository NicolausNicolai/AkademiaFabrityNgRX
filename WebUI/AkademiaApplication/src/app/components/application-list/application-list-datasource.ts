...
/**
 * Data source for the ApplicationList view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class ApplicationListDataSource extends DataSource<Application> {
  data: Application[] = [];
  paginator: MatPaginator | undefined;
  sort: MatSort | undefined;

  constructor(applications : Observable<Array<Application>>) {
    super();

    applications.subscribe(r => this.data = r);
